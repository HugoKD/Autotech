...
bool covaps__msg__order__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("covaps.msg._order.Order", full_classname_dest, 23) == 0);
  }
  covaps__msg__Order * ros_message = _ros_message;
  {  // val
    ...
    ros_message->val = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // type
...
PyObject * covaps__msg__order__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("covaps.msg._order");
  ...
  {  // val
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->val);
    {
